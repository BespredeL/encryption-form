# EncryptionForm - Шифрование форм на клиенте
...
🔐 Защита данных формы ещё до отправки на сервер

EncryptionForm - это лёгкое решение для шифрования данных формы на стороне клиента (в браузере) перед отправкой на сервер.

Позволяет защитить чувствительные данные: **пароли, персональную информацию и другие конфиденциальные поля.**
...
2. Данные шифруются в браузере
3. На сервер отправляется зашифрованный payload
4. Сервер расшифровывает данные
5. Приложение их обрабатывает
